<?php
/**
* Loop template for post list with layout masonry
...
$data_attrs		= sprintf( ' data-post-id="post-%s"', get_the_ID() ); ?>

	<article class="<?php echo implode( ' ', $post_class ); ?>"<?php print( $data_attrs ); ?>>
		<?php if ( in_array( 'sticky', $post_class ) ) : ?><div class="sticky-icon"></div><?php endif; ?>
		<?php fallsky_list_featured_section(); ?>
