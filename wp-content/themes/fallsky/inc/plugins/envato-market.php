...
if ( ! class_exists( 'Envato_Market_Github' ) ) :
	...
	class Envato_Market_Github {
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'fallsky' ), '1.0.0' );
		}
		...
		public function notice() {
			...
			if ( 'deactivated' === $state ) {
				...
				$message = sprintf(
					esc_html__( '%sActivate the Envato Market plugin%s to get updates for your ThemeForest and CodeCanyon items.', 'fallsky' ),
				...
				$message = sprintf(
					esc_html__( '%sInstall the Envato Market plugin%s to get updates for your ThemeForest and CodeCanyon items.', 'fallsky' ),
