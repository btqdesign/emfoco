...
if ( ! class_exists( 'Fallsky_Customize_Header' ) ) {
	class Fallsky_Customize_Header extends Fallsky_Customize_Base {
		...
		public function register_controls($wp_customize){
			...
			$wp_customize->add_setting( new WP_Customize_Setting( $wp_customize, 'fallsky_site_header_show_social_menu', array(
				'default'   		=> $fallsky_default_settings['fallsky_site_header_show_social_menu'],
				'transport' 		=> 'refresh',
				'sanitize_callback' => 'fallsky_sanitize_checkbox'
			) ) );
			...
			$wp_customize->add_control( new Fallsky_Customize_Control( $wp_customize, 'fallsky_site_header_show_social_menu', array(
				'type'					=> 'checkbox',
				'label_first'		 	=> true,
				'label' 				=> esc_html__( 'Display Social Menu', 'fallsky' ),
				'section'  				=> 'fallsky_section_header_layout',
				'settings' 				=> 'fallsky_site_header_show_social_menu',
				'description'			=> sprintf(
		...
		public function site_header_main_elements() {
			...
			$is_style_1_2		= in_array( $style, array( 'site-header-layout-1', 'site-header-layout-2' ) );
			...
			$show_social_menu 	= fallsky_module_enabled( 'fallsky_site_header_show_social_menu' );
			...
			if ( $show_social_menu && $is_style_1_2 ) {
				$this->display_site_header_social_menu();
			}
			ob_start();
			// Show social menu if enabled
			if ( $show_social_menu && ! $is_style_1_2 ) {
				$this->display_site_header_social_menu();
			}
			...
			empty( $buttons )  && empty( $social_menu_html ) ? '' : printf( $wrap_div, $buttons );
		}
		...
		private function display_site_header_social_menu() {
