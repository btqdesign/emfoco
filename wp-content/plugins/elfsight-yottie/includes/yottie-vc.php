	...
	vc_map(array(
		...
		'params' => array(
			...
			array(
				...
				'value' => array(
					__('Privacy-Enhanced Mode', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $header_visible ? 'yes' : 'no'
				),
				'std' => 'no',
				'description' => __('This option enables Privacy-Enhanced Mode, which uses youtube-nocookie.com domain upon watching videos. This mode improves privacy and YouTube won\'t store information about visitors on your website unless visitors play YouTube videos in the plugin. This mode also disables Subscribe Button in the header and popup, since this button uses cookie. It was added in attempt to achieve more compliance with the European Union\'s GDRP, the General Data Protection Regulation, on May 25, 2018.', ELFSIGHT_YOTTIE_TEXTDOMAIN),
				'group' => 'Source'
			),
			...
			array(
				'type' => 'checkbox',
				'param_name' => 'content_pagination_control',
				'value' => array(
					__('Pagination control', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_pagination_control ? 'yes' : 'no'
				),
				'std' => 'yes',
				'description' => __('Activate pagination in the video gallery.', ELFSIGHT_YOTTIE_TEXTDOMAIN),
				'group' => 'Content'
			),
			array(
				'type' => 'checkbox',
				...
				'value' => array(
					__('Search', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_search ? 'yes' : 'no'
				),
				'std' => 'yes',
				'description' => __('Turn on/off search by title and description in source group.', ELFSIGHT_YOTTIE_TEXTDOMAIN),
				'group' => 'Content'
			),
			array(
				'type' => 'dropdown',
