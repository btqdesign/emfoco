        ...
        <div class="yottie-demo-accordion">
            <div class="yottie-demo-accordion-item-active yottie-demo-accordion-item">
                ...
                <div class="yottie-demo-accordion-item-content">
                    ...
                    <div class="yottie-demo-field-group">
                        <div class="yottie-demo-cache-time yottie-demo-field">
                            <label>
                                <input type="hidden" name="noCookies" value="false">
                                <input class="yottie-demo-checkbox" type="checkbox" name="noCookies" value="true">
                                <span class="yottie-demo-checkbox-label"><?php _e('Privacy-Enhanced Mode', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></span>
                            </label>
                            ...
                            <span class="yottie-demo-tooltip">
                                ...
                                <span class="yottie-demo-tooltip-content">
                                    <span class="yottie-demo-tooltip-content-inner">
                                        <?php _e('This option enables Privacy-Enhanced Mode, which uses youtube-nocookie.com domain upon watching videos. This mode improves privacy and YouTube won\'t store information about visitors on your website unless visitors play YouTube videos in the plugin. This mode also disables Subscribe Button in the header and popup, since this button uses cookie. It was added in attempt to achieve more compliance with the European Union\'s GDRP, the General Data Protection Regulation, on May 25, 2018.', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?>
                                    </span>
                                </span>
                            </span>
                        </div>
            ...
            <div class="yottie-demo-accordion-item">
                ...
                <div class="yottie-demo-accordion-item-content">
                    ...
                    <div class="yottie-demo-field-group">
                        <div class="yottie-demo-controls">
                            <div class="yottie-demo-field">
                                <div class="yottie-demo-field-name">
                                ...
                                <label class="yottie-demo-controls-item">
                                    <input type="hidden" name="contentPaginationControl" value="false">
                                    <input class="yottie-demo-checkbox" type="checkbox" name="contentPaginationControl" value="true">
                                    <span class="yottie-demo-icon-control-pagination-white yottie-demo-icon"></span>
                                    <span class="yottie-demo-icon-control-pagination-black yottie-demo-icon-active yottie-demo-icon"></span>
                                    <span class="yottie-demo-controls-item-label"><?php _e('Pagination', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="yottie-demo-field-group">
                        <div class="yottie-demo-search yottie-demo-field">
                            <label>
                                <input type="hidden" name="contentSearch" value="false">
                                <input class="yottie-demo-checkbox" type="checkbox" name="contentSearch" value="true">
                                <span class="yottie-demo-checkbox-label"><?php _e('Search', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></span>
                            </label>
                        </div>
